              ...
              <div className={baseContentStyle.listContent}>
                <div className={baseContentStyle.leading}>
                  {car.itemType === PromptTypes.CUSTOM ? (
                    ...
                    <img
                      className={baseContentStyle.leadingIcon}
                      src={getImageSrc(car.imageKey)}
                      alt={""}
                    />
                  )}
                  <div className={baseContentStyle.leadingText}>
                    {car.title}
                  </div>
                </div>
                <img
                  className={baseContentStyle.pinIcon}
                  src={car.isSelect ? DingSelectIcon : DingUnSelectIcon}
                  alt=""
                  onClick={(e) => {
                    e.stopPropagation()
          ...
          <div
            ...
            <div
              ...
              <div
                ...
                <img
                  ...
                  className={"block w-[20px] h-[20px] mr-[4px]"}
                  src={PupHeaderIcon}
                  alt=""
                />
              </div>
            ...
            <div>
              <SearchBar
                ...
                onItemClick={(id) => {
                  goToAskEngine(selectedText, id, null)
                }}
                onItemSearchClick={() => {
            ...
            <div
              ...
              <img
                className={"w-[20px] h-[20px] ms-[8px] me-[8px] cursor-pointer"}
                src={SmallAskAiIcon}
                onMouseEnter={() => {
                  setVisibleAsk(true)
                }}
