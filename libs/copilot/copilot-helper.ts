    ...
    arguments: [
      {
        ...
        message: {
          ...
          imageUrl:
            "https://copilot.microsoft.com/images/blob?bcid=" + imageSource,
          originalImageUrl:
            "https://copilot.microsoft.com/images/blob?bcid=" + imageSource,
          adaptiveCards: [],
          author: "user",
          ...
          if (adaptiveCards && adaptiveCards.length) {
            ...
            if (adaptiveCard["type"] === "AdaptiveCard") {
              if (adaptiveCard["body"] && adaptiveCard["body"].length) {
                ...
                attributionsTextBlock = findBlockIdAdaptiveCardText(
                  adaptiveCard["body"]
                )
              }
            }
        ...
        if (item && item["result"]) {
          ...
          if (value === "InvalidRequest") {
            ...
            if (createImageMessage) {
              ...
              conversationDone.appendix = new CopilotImageCreateAppendix(
                text,
                messageId
              )
