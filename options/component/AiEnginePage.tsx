...
export default function AiEnginePage() {
  ...
  const promptTipsBr = (
    <div>
      Quick Action allows users to personalize prompts for selected text. The
      ...
      {PROMPT_PLACEHOLDER_LANG} and convey your selected keywords to the prompt
      using {PROMPT_PLACEHOLDER_TEXT}. For instance,
      <br />
      Translate {PROMPT_PLACEHOLDER_TEXT} to {PROMPT_PLACEHOLDER_LANG}.
    </div>
  )
        ...
        void setCards(
          update(cards, {
            [index]: {
              ...
              text: {
                $set: inputValue.includes(PROMPT_PLACEHOLDER_TEXT)
                  ? inputValue
                  : `${inputValue}${PROMPT_PLACEHOLDER_TEXT}`
              },
    ...
    <div>
      <div
        ...
        <div
          ...
          Customize your menu of actions by editing, rearranging through
          dragging, and including custom actions below.
        </div>
        <div ref={drop}>
          {cards.map((card) => (
            <Card
        ...
        <div
          ...
          <div className={"text-[#0A4DFE] font-[400] text-[15px] ml-[8px]"}>
            Create new shortcut
          </div>
        </div>
      ...
      <Modal
        ...
        <div className={"flex flex-col items-start pl-[20px] w-full"}>
          ...
          <div
            className={"h-[1px] w-[620px] bg-[#DADCE0] justify-start mt-[24px]"}
          />
