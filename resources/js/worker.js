;(function () {
  ...
  ;(function (v) {
    ;(function () {
      ...
      var C = !S && typeof self == "object",
        Dt =
          !b.JS_SHA3_NO_NODE_JS &&
          typeof process == "object" &&
          process.versions &&
          process.versions.node
      Dt ? (b = Zt) : C && (b = self)
      for (
        var $t = !b.JS_SHA3_NO_COMMON_JS && !0 && v.exports,
          Ht = !b.JS_SHA3_NO_ARRAY_BUFFER && typeof ArrayBuffer < "u",
          p = "0123456789abcdef".split(""),
          st = [31, 7936, 2031616, 520093696],
          Tt = [4, 1024, 262144, 67108864],
          te = [1, 256, 65536, 16777216],
          ee = [6, 1536, 393216, 100663296],
          d = [0, 8, 16, 24],
          zt = [
          ...
          Jt = [224, 256, 384, 512],
          Ot = [128, 256],
          Kt = ["hex", "buffer", "arrayBuffer", "array", "digest"],
          jt = {
            128: 168,
            256: 136
          },
          re =
            b.JS_SHA3_NO_NODE_JS || !Array.isArray
              ? function (t) {
                  return Object.prototype.toString.call(t) === "[object Array]"
                }
              : Array.isArray,
          ne =
            Ht && (b.JS_SHA3_NO_ARRAY_BUFFER_IS_VIEW || !ArrayBuffer.isView)
              ? function (t) {
                  return (
                    typeof t == "object" &&
                    t.buffer &&
          ...
          Mt = function (t) {
            ...
            if (e !== "object" || t === null) throw new Error(y)
            if (Ht && t.constructor === ArrayBuffer)
              return [new Uint8Array(t), !1]
            if (!re(t) && !ne(t)) throw new Error(y)
            return [t, !1]
          },
          Pt = function (t) {
          ...
          oe = function (t, e) {
            var r = jt[t],
              n = Gt(t, e, "hex")
            return (
              (n.create = function (a, o, f) {
                return Pt(o) && Pt(f)
                  ? x["shake" + t].create(a)
                  : new h(t, e, a).bytepad([o, f], r)
              }),
      ...
      ;(h.prototype.update = function (t) {
        if (this.finalized) throw new Error(_)
        var e = Mt(t)
        t = e[0]
        for (
          var r = e[1],
          ...
          if (this.reset)
            for (this.reset = !1, n[0] = this.block, u = 1; u < f + 1; ++u)
              n[u] = 0
          if (r)
              ...
              (c = t.charCodeAt(i)),
                c < 128
                  ...
                  : c < 2048
                    ...
                    : c < 55296 || c >= 57344
                      ? ((n[u >> 2] |= (224 | (c >> 12)) << d[u++ & 3]),
                        (n[u >> 2] |= (128 | ((c >> 6) & 63)) << d[u++ & 3]),
                        (n[u >> 2] |= (128 | (c & 63)) << d[u++ & 3]))
                      : ((c =
                          65536 +
                          (((c & 1023) << 10) | (t.charCodeAt(++i) & 1023))),
            ...
            for (u = this.start; i < o && u < a; ++i)
              n[u >> 2] |= t[i] << d[u++ & 3]
          if (((this.lastByteIndex = u), u >= a)) {
            for (this.start = u - a, this.block = n[f], u = 0; u < f; ++u)
              l[u] ^= n[u]
            B(l), (this.reset = !0)
          } else this.start = u
        }
        ...
        (h.prototype.bytepad = function (t, e) {
          ...
          var a = (e - (r % e)) % e,
            o = []
          return (o.length = a), this.update(o), this
        }),
        ...
        (h.prototype.arrayBuffer = function () {
          ...
          for (var l = new Uint32Array(i); o < r; ) {
            for (a = 0; a < t && o < r; ++a, ++o) l[o] = e[a]
            o % t === 0 && ((e = gt(e)), B(e))
          }
          return n && ((l[o] = e[a]), (i = i.slice(0, f))), i
        }),
        (h.prototype.buffer = h.prototype.arrayBuffer),
        (h.prototype.digest = h.prototype.array =
          function () {
            this.finalize()
            for (
              var t = this.blockCount,
      ...
      ;(Nt.prototype = new h()),
        (Nt.prototype.finalize = function () {
          return (
            this.encode(this.outputBits, !0), h.prototype.finalize.call(this)
          )
        })
      var B = function (t) {
        var e,
      ...
      if ($t) v.exports = x
      else for (A = 0; A < w.length; ++A) b[w[A]] = x[w[A]]
    })()
  })(It)
  var Qt = It.exports
  function Xt(v) {
  ...
  async function qt(v, y, _) {
    ...
    for (let b = 0; b < 5e5; b++) {
      ;(_[3] = b), (_[9] = Math.round(performance.now() - S))
      const C = Xt(_)
      if (Qt.sha3_512(v + C).slice(0, y.length) <= y) return C
    }
