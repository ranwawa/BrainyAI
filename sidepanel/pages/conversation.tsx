...
} from "~porvider/sidepanel/ConversationProvider"
...
import ModelManagementProvider, {
  ...
  type M,
  type Ms
} from "~porvider/ModelManagementProvider"
        ...
        return (
          <div
            ...
            <div
              ...
              {item.imageKey != null && (
                <div className={"w-[16px] h-[16px] mr-[4px] cursor-pointer"}>
                  {item.itemType === PromptTypes.CUSTOM ? (
                    <ItemIcon style={{ fontSize: "16px", color: "#0057FF" }} />
                  ) : (
                    <img
              ...
              <div className={"text-[#0057FF] text-[12px] whitespace-nowrap"}>
                {item.title}
              </div>
            </div>
          </div>
        ...
        errMessage = (
          <div className="w-fit">
            ...
            <div className="mt-4 text-[12px] leading-loose">
              If there is no response for a long time, please try to refresh
              manually.
              <u
      ...
      case ErrorCode.CAPTCHA:
        errMessage = (
          <div className="w-fit">
            ...
            <div>
              You need to complete the {name} Captcha Challenge to continue
              using it. Please proceed to the challenge.
            </div>
        ...
        errMessage = (
          <div className="w-fit">
            ...
            {error?.message ? (
              ...
              <div className="mb-3">
                Conversation limit reached. Please try it later. Or you can
                check your
                <u
            ...
            <u
              className={"text-[14px] text-[#0A4DFE] cursor-pointer"}
              onClick={clickRefresh}>
              Click to Refresh
            </u>
          </div>
      ...
      case ErrorCode.UPLOAD_FILE_NOT_SUPPORTED:
        errMessage = (
          <div className="w-fit">
            ...
            <div className="mb-3">
              This model cannot support PDF/Image analysis functions. You can
              switch models to access this function.
            </div>
            <u
              className={"text-[14px] text-[#0A4DFE] cursor-pointer"}
              onClick={switchModel}>
      ...
      case ErrorCode.MODEL_NO_PERMISSION:
        errMessage = (
          <div className="w-fit">
            ...
            <u className={"text-[14px] text-[#0A4DFE] cursor-pointer"}>
              Click to Switch
            </u>
          </div>
        )
      ...
      case ErrorCode.FILE_OTHER:
        errMessage = (
          <div className="w-fit">
            ...
            <div className="mb-3">
              The current model encountered an error while analyzing the
              image/PDF file. You can switch models to proceed with your
              request.
            </div>
            <u
              className={"text-[14px] text-[#0A4DFE] cursor-pointer"}
        ...
        errMessage = (
          <div className="w-fit">
            ...
            <ul className="list-disc leading-loose pl-4">
              <li>
                Ensure the internet connection is stable or try to switch
                networks.
              </li>
              <li>
                Make sure your{" "}
...
const AITextContent = ({
  ...
  const copyClick = async () => {
    navigator.clipboard
      .writeText(currentBotResponseMessage[activePage - 1].message_text ?? "")
      .then(() => {
          ...
          <div
            ...
            {isLastChatInList && (
              <div className="pr-[16px] flex items-center">
                <img
                  src={activePage == 1 ? ArrowLIcon : ArrowLDeepIcon}
  ...
  return (
    <div>
      {currentBotResponseMessage.map((item, index) => {
        return (
          <div
            className={activePage === index + 1 ? "block" : "hidden"}
            key={index}>
            <div className="px-4 pb-4 rounded-b-[10px] mb-2 bg-white">
              ...
              {item.error ? (
                <AIError
                  start={start}
                  setCurrentBotResponseMessage={setCurrentBotResponseMessage}
...
export const AIMessage = memo(
  ({ message, i }: { message: ConversationMessage; i: number }) => {
    ...
    const { currentBots, setCurrentBots, allModels, saveCurrentBotsKeyLocal } =
                ...
                <div
                  ...
                  <div className="flex justify-end items-center">
                    {model.supportUploadPDF && (
                      <img className="ml-1" src={IconPdf} alt="" />
                    )}
                    {model.supportUploadImage && (
                      <img className="ml-1" src={IconPic} alt="" />
                    )}
                    {model.maxTokenLimit && (
          ...
          <div className="bg-[#4948DB] text-sm p-4">
            {message.data.promptImageTitle && (
              <div
                ...
                style={{ marginBottom: message.data.text ? 8 : 0 }}>
                {message.data.promptImageUri &&
                  (message.data.promptType === 2 ? (
                    ...
                    <img
                      className="w-4 h-4"
                      src={getGrayImageSrc(message.data.promptImageUri!)}
                      alt=""
                    />
                  ))}
              ...
              {message.data.uploadFile![3] == FileTypes.Image ? (
                <div
                  ...
                  <img
                    ...
                    src={
                      message.data.uploadFile ? message.data.uploadFile[0] : ""
                    }
                    alt=""
                  />
                  <div
                    ...
                    <div
                      ...
                      <div
                        ...
                        <div
                          ...
                          style={{ backgroundImage: `url(${FileBgIcon})` }}>
                          <div
                            className={
          ...
          return (
            <div
              ...
              {message.foree === "user" ? (
                ...
                <AIMessage key={message.id} message={message} i={index} />
              )}
            </div>
          )
        })}
  ...
  async function fileUpload(file: File) {
    ...
    try {
      ...
      setIsUploading([
        true,
        true,
        fileType == FileTypes.OTHERS ? PdfIcon : URL.createObjectURL(file),
        file.name,
        new Map(),
        fileType,
        file
  ...
  const PopupPrompt = ({ isQuotClick }) => (
    <div
      ...
      <div
        ...
        <div
          className={"w-fit text-right text-[#C2C2C2] text-[12px] mr-[16px]"}>
          {"⇧ ⌘ ⏎"}
        </div>
      </div>
    </div>
        ...
        <div className={style.chatInputTopBar}>
          <div className={"flex flex-row justify-start items-center"}>
            ...
            <img
              ...
              alt=""
              className={"w-[16px] h-[16px] ms-[12px] cursor-pointer"}
        ...
        <div
          ...
          {isHaveQuotingText && (
            <div className={"flex flex-col items-center w-full"}>
              ...
              <div
                ...
                <PromptTags
                  ...
                  itemClick={(
                    ...
                    index: number,
                    e: React.MouseEvent<HTMLDivElement>
                  ) => itemClick(car, index, true, e)}></PromptTags>
                <Popover
                  title={null}
                  align={{ offset: [0, 20] }}
                  ...
                  <img
                    ...
                    style={{
                      visibility:
                        Math.max(...promptVisibleTag) + 1 < cards.length
                          ? "visible"
                          : "hidden"
                    }}
                  />
              ...
              <div
                className={"w-[calc(100%-16px)] h-[1px] bg-[#F6F6F6] mt-[8px]"}
              />
            </div>
          )}
          {isUploading[0] && (
            <div className={"flex flex-col w-full"}>
              <div
                  ...
                  <div className={"w-[48px] h-[48px] my-[4px] ml-[4px]"}>
                    {isUploading[1] ? (
                      <div
                        ...
                        <LoadingOutlined
                          className={"text-[32px] text-[#0A4DFE]"}
                        />
                      </div>
                      ...
                      <div
                        ...
                        <div
                          ...
                          <div
                            ...
                            {isUploading[3].split(".").pop()?.substring(0, 4)}
                          </div>
                        </div>
                      </div>
                    )}
                ...
                <img
                  className={"w-[16px] h-[16px] mx-[20px] cursor-pointer"}
              ...
              <div className={"w-auto mr-[8px]"}>
                <PromptTags
                  cards={
                    isUploading[5] == FileTypes.Image ? imageCards : pdfCards
                  }
                  onVisibleTagChange={() => {
                    /* do nothing */
                  }}
      ...
      <Modal
        ...
        <div
          ...
          <div
            ...
            <div className={"text-[#C2C2C2] text-[16px] font-[700]"}>
              Upload file
            </div>
            <img
              className={"w-[16px] h-[16px] cursor-pointer"}
          ...
          <div
            ...
            <div className={"text-[#5E5E5E] text-[14px] mt-[16px] mx-[24px]"}>
              Upload a file to receive intelligent answers to your questions or
              requests
            </div>
            <div
              ...
              <Dragger
                ...
                <p className="ant-upload-hint">
                  Depending on the different models, support for file formats
                  such as PDF, TXT, PNG, etc. (max size 20MB)
                </p>
              </Dragger>
            </div>
          </div>
